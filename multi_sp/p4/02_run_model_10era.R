...
run_prep_model(file_sim[run_id], case = 'detected', range="yes", model = 'ms-nimble', time.interval.yr = 10)
run_prep_model(file_sim[run_id], case = 'detected', range="no", model = 'ms-nimble', time.interval.yr = 10)

run_prep_model(file_sim[run_id], case = 'visits', range="yes", model = 'ms-nimble', time.interval.yr = 10)
run_prep_model(file_sim[run_id], case = 'visits', range="no", model = 'ms-nimble', time.interval.yr = 10)
