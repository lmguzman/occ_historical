...
run_all_simulation_1 <-function(s, all_scenarios){
  ...
  save(sim.data,
       file=paste0("p2.1/outputs/", "sim.data/",
                   
                   "_r_",all_scenarios[s,'r'],"_p.yr_",all_scenarios[s,'p.yr'],"_mu.phi.yr_",all_scenarios[s,'mu.phi.yr'],
                   "_mu.gam.yr_",all_scenarios[s,'mu.gam.yr'], "_nyr_",all_scenarios[s,'nyr'],"_range_", all_scenarios[s,'type.range'], "_visit_", all_scenarios[s,'type.visit'],
                   ".RData"))
