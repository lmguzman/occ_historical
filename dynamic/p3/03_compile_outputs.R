...
file_sim <- list.files("p3/outputs/model.res/")

compiled_res <- list()

for(i in 1:length(file_sim)){
  
  load(paste0("p3/outputs/model.res/",file_sim[i]), verbose = TRUE)
...
saveRDS(all_outputs, 'p3/outputs/model.res/all_outputs.rds')
